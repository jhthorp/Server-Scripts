#!/bin/bash
################################################################################
#                    Download Burn-In Results From TrueNAS                     #
#                                                                              #
#             This script will export a single function that will              #
#               download the output files from a Burn-In process               #
################################################################################
...
#===============================================================================
# This function will download the output files from a Burn-In process.
#
# GLOBALS / SIDE EFFECTS:
#   N_A - N/A
#
...
download_burnin_results ()
{
  ...
  local results_dir="${CUR_DIR}/../../_burnin_results"

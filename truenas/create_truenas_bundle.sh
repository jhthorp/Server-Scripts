#!/bin/bash
################################################################################
#                            Create TrueNAS Bundle                             #
#                                                                              #
#              This script will export a single function that will             #
#          create an archive bundle for uploading to a TrueNAS server          #
################################################################################
...
#
# ARGUMENTS:
#   [1 - completeBundleName] The name for the output bundle
#
# OUTPUTS:
#   N/A - N/A
#
...
{
  local completeBundleName=${1-"TrueNAS"}
